...
> [!Warning]
> Experiments for a large scale 3D-lattice Ising model consumes *a lot of* energy and time. If you do not have a desktop, we strongly recommend you to steal a server from a compiler lab or a deep learning lab, for they would have a server with decent CPUs.
